...
class User
{
	...
	public function createUserAccount($username,$email,$password)
	{
		if($this->emailExists($email)){
			...
			$notes="";
			$usertype="Admin";
			$pre_stmt=$this->con->prepare("INSERT INTO `user`(`username`, `email`, `password`, `usertype`, `reister_date`, `last_login`, `notes`) VALUES (?,?,?,?,?,?,?)");
...
//$user=new User();
//echo $user->userLogin("kousrini99@yahoo.com","1234");
?>